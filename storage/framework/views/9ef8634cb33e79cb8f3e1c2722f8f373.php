        ...
        <div class="card">
            <div class="card-body p-3">
                <div class="d-flex align-items-center justify-content-between mb-3">
                    <div>
                        <h1 class="h6 mb-1">Stock Adjustment</h1>
        ...
        <div class="card">
            <div class="card-body p-3">
                ...
                <div class="table-responsive">
                    <table class="table table-hover align-middle mb-0 inventory-product-table">
    ...
    <div class="col-12">
        <div class="card" id="logsSection">
            <div class="card-body p-3">
                ...
                <div class="table-responsive">
                    <table class="table table-sm align-middle mb-0 inventory-compact-table inventory-log-table">
                        <thead class="table-light">
                            <tr>
                                <th>Date/Time</th>
                                <th>User</th>
