            ...
            <tbody>
                <?php $__empty_1 = true; $__currentLoopData = $transactions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $payment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <tr>
                        ...
                        <td class="text-end fw-semibold">&#8369;<?php echo e(number_format($payment->sales_amount, 2)); ?></td>
                        <td class="text-end">
                            &#8369;<?php echo e(number_format($payment->tendered_amount, 2)); ?>

                            <?php if($payment->change_amount > 0): ?>
                                <div class="small text-muted">Change &#8369;<?php echo e(number_format($payment->change_amount, 2)); ?></div>
                            <?php endif; ?>
                        </td>
                    </tr>
