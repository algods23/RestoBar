    ...
    <div class="col-lg-4">
        <div class="card sticky-top" style="top: 88px; padding: 10px 12px;">
            ...
            <div id="cartTotals" class="border-top pt-1 mt-1" style="font-size: 12px;">
                ...
                <div class="d-flex justify-content-between"><span>Discount <small id="cart_discount_percent" class="text-muted">(0%)</small></span><strong id="cart_discount">₱<?php echo e(number_format($totals['discount_amount'], 2)); ?></strong></div>
...
document.getElementById('confirmAddToOrderBtn').addEventListener('click', async () => {
    ...
    try {
        const res = await fetch(`<?php echo e(route('pos.add_to_order')); ?>`, {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json',
                'X-CSRF-TOKEN': csrf,
